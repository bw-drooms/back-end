  ...
  return knex('jobseeker').del()
    .then(function () {
      ...
      return knex('jobseeker').insert([
        ...
        {jobseeker_name: 'Devin Warrick' , location: 'Carrollton, TX', general_profession: 'Full Stack Software Engineer', description: 'Experienced Operations Trainer with a demonstrated history of working in the retail industry.', linkedIn: 'https://www.linkedin.com/in/devin-warrick-47bbb7104/'},
