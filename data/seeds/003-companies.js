  ...
  return knex('company').del()
    .then(function () {
      ...
      return knex('company').insert([
        ...
        {location: 'Austin', position: 'Software Engineer', description: 'At Volusion, we make products that people love. Our teams are dedicated to providing SaaS commerce solutions and services for all business types, ranging from startups to large enterprises.', pay_range: 75000, selected: false, company_id: 3 },
